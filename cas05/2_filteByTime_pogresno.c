 ...
 * 
 * Napomena:
 * - zaboravljen return na kraju funkcije koja se prosledjuje nftw-u
 * je primer ceste greske na ispitu. U slucaju da se ne navede -Wall -Wextra
 * pri kompajliranju, nece biti prijavljeno upozorenje da fali return.
 */
